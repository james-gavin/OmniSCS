...
public class ItemBuilder {
    ...
    public ItemBuilder addToLore(String... parts) {
        ...
        lore.addAll((Collection<? extends String>)Arrays.<String>stream(parts).map(part -> ChatColor.translateAlternateColorCodes('&', part)).collect(Collectors.toList()));
        meta.setLore(lore);
        this.item.setItemMeta(meta);
        return this;
    }
    ...
    public ItemBuilder setLore(Collection<String> l) {
        ...
        ItemMeta meta = this.item.getItemMeta();
        lore.addAll((Collection<? extends String>)l.stream().map(part -> ChatColor.translateAlternateColorCodes('&', part)).collect(Collectors.toList()));
        meta.setLore(lore);
        this.item.setItemMeta(meta);
        return this;
    }
